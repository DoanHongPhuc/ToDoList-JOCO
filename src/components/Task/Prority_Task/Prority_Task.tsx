    ...
    if(!view){
        return(
            <div className="prority_task_item flex pb-4 pt-2 relative">
                <button className='prority_task_checkbox_btn mr-2 flex items-start mt-1' onClick={()=>{props.handleTaskComplete(props.task.task_id)}}>
