...
function SideBar(props: any) {
    ...
    function handleLogout(e: any) {
        e.preventDefault();
        updateToken(null, null, null,null);
    }
    ...
    if (props.path === '/priority') {
        priorityClassname = 'nav-item-select flex items-center w-full p-1.5 p-1 text-base font-medium py-2 rounded-md'
    }
    ...
    if (!open) {
        return (
            <div className="Close text-base text-slate-500 w-8 m-3 hover:cursor-pointer w-9 h-9 rounded-lg hover:bg-gray-200 flex items-center justify-center" onClick={() => setOpen(true)}>
            ...
            <div className="header_container">
                <div className="header flex p-3 justify-between">
                    ...
                    <div className="Icon flex justify-center items-center">
                        ...
                        <div className="Close text-base text-slate-500 w-8 hover:cursor-pointer" onClick={() => setOpen(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="M19 4.001H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-12a2 2 0 0 0-2-2Zm-15 2a1 1 0 0 1 1-1h4v14H5a1 1 0 0 1-1-1v-12Zm6 13h9a1 1 0 0 0 1-1v-12a1 1 0 0 0-1-1h-9v14Z" clipRule="evenodd"></path></svg>
                        </div>
                    </div>
                </div>
                        ...
                        <li>
                            <Link to={'/priority'} onClick={()=>{props.clearCache()}}>
                                <div className={priorityClassname}>
                                    ...
                                    <p className='h-6 ml-1.5'> Priority</p>
                                </div>
                            </Link>
                        </li>
                        <li>
