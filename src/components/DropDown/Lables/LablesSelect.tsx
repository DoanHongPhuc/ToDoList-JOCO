...
function  LabelSelect(props:propsType) {
    ...
    return (
        <div className="task_editor_labels relative">
            <button onClick={(e)=>{e.preventDefault(); setIsVisible(!isVisible)}} id="task_editor_labels_btn" className="task_editor_label_btn px-1.5 border border-gray-300 rounded text-xs text-gray-500 leading-7 hover:bg-gray-100">
