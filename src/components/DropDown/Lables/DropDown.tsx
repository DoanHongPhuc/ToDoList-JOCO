    ...
    return(
        <div id ="task_editor_labels_dropdown" className="task_editor_labels_dropdown text-sm  absolute -left-14 top-8 border rounded-lg border-gray-300/[0.6] bg-white overflow-hidden z-10">
            ...
            {labelList.map((label,index)=>{
                return(
                    <div onClick={()=>{props.handlelabelsSelect(label.label_id)}} key={index} className="task_editor_label_option flex items-center pl-2 pr-3.5 py-1 leading-8 hover:cursor-pointer hover:bg-gray-100 ">
