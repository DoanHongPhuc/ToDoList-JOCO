...
function PriorityDropDown(props:any){
    const priorityList = [
        {
            priority_id: 1,
        ...
        },
        {
            ...
            priority_icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="g1pQExb" data-icon-name="priority-icon" data-priority="4"><path fill="currentColor" fillRule="evenodd" d="M4 5a.5.5 0 0 1 .223-.416C5.313 3.857 6.742 3.5 8.5 3.5c1.113 0 1.92.196 3.658.776C13.796 4.822 14.53 5 15.5 5c1.575 0 2.813-.31 3.723-.916A.5.5 0 0 1 20 4.5V13a.5.5 0 0 1-.223.416c-1.09.727-2.518 1.084-4.277 1.084-1.113 0-1.92-.197-3.658-.776C10.204 13.178 9.47 13 8.5 13c-1.45 0-2.614.262-3.5.777V19.5a.5.5 0 0 1-1 0V5Zm4.5 7c-1.367 0-2.535.216-3.5.654V5.277c.886-.515 2.05-.777 3.5-.777.97 0 1.704.178 3.342.724 1.737.58 2.545.776 3.658.776 1.367 0 2.535-.216 3.5-.654v7.377c-.886.515-2.05.777-3.5.777-.97 0-1.704-.178-3.342-.724C10.421 12.196 9.613 12 8.5 12Z" clipRule="evenodd"></path></svg>
        }      
    ]
    return(
        <div id ="task_editor_priority_dropdown" className="task_editor_priority_dropdown absolute -left-5 top-8 border rounded-lg border-gray-300 bg-white overflow-hidden z-10">
            {priorityList.map((priority,index)=>{
                return(
                    <div onClick={()=>{props.handlePrioritySelect(priority.priority_id)}} key={index} className="task_editor_x_option flex items-center px-2 py-1 leading-8 hover:cursor-pointer hover:bg-gray-100 ">
                        <div className="task_editor_priority_option_container flex items-center">
                            <div className="task_editor_priority_option_icon mr-2.5">
