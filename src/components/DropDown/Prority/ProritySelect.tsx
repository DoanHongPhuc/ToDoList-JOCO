...
function  ProritySelect(props:any) {
    ...
    function handleProritySelect(priority_id :number){
        props.onChangePrority(priority_id)
        setIsVisible(false)
    }
    return (
        <div className="task_editor_priority relative">
            ...
            {isVisible && <ProrityDropDown priority_id = {props.priority_id} handleProritySelect = {handleProritySelect}/>}
        </div>
    )
}
