...
function DueDateDropDown(props: any) {
    ...
    return (
        <div id='due_date_dropdown' className="due_date_dropdown absolute left-0 top-8 border rounded-lg border-gray-300 bg-white z-10">
            <div className="due_date_dropdown_title font-light text-sm pl-4 pt-1 pr-2 text-base leading-8 mb-1">
                <DateField
                    value={value}
                />
            </div>
            <div className="due_date_dropdown_date_select border-b border-gray-300 my-2">
