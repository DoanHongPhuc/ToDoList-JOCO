...
function DueDateDrapDown( props:any){
    ...
    const handleSaveClick=(e:any)=>{
        e.preventDefault();
        if (time !=="" && value.startDate !==null){
            const due_date = value.startDate+' '+ time
            props.handleSaveClick(due_date)
        }
    }
    function getToday(){
    ...
    return(
        <div id='due_date_dropdown' className="due_date_dropdown absolute left-0 top-8 border rounded-lg border-gray-300 bg-white z-10">
            <div className="due_date_dropdown_title font-light text-sm pl-4 pt-1 pr-2 text-base leading-8 border-b border-gray-300 mb-1">
                {props.title}
            </div>
            <div className="due_date_dropdown_date_select border-b border-gray-300 my-1">
            ...
            <div className="due_date_dropdown_date_input_area p-1">
                <Datepicker 
            ...
            <div className="due_date_dropdown_time_input_area p-1 relative">
                <input
                    type="text"
                ...
                />
                <button type="button" className="absolute right-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M13.5 8a5 5 0 1 1-10 0 5 5 0 0 1 10 0Zm1 0a6 6 0 1 1-12 0 6 6 0 0 1 12 0Zm-6-2.5a.5.5 0 0 0-1 0v3A.5.5 0 0 0 8 9h3a.5.5 0 0 0 0-1H8.5V5.5Z" clip-rule="evenodd"></path></svg>
                </button>
            </div>
...
export default DueDateDrapDown;