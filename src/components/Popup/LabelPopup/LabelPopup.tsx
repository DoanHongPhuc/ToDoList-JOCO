...
function LabelPopup(props:any) {
    ...
    return (
        <div className="label_popup ">
            {
                props.type === 'add' ?
                <button onClick={()=>{setDisplay(true)}} className='label_popup_btn h-6 w-6 flex items-center justify-center rounded-lg hover:bg-gray-100'>
                ...
                :
                <button onClick={()=>{setDisplay(true)}} className='label_item_edit_btn h-7 w-7 flex items-center justify-center rounded-lg hover:bg-gray-100'>
